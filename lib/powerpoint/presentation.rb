...
module Powerpoint
  class Presentation
    ...
    def add_dashboard_widget(title, image_path, content = [])
      @slides << Powerpoint::Slide::DashboardWidget.new(presentation: self, title: title, image_path: image_path, content: content)
    end
